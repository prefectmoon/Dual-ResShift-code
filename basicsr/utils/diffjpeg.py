...
if __name__ == '__main__':
    ...
    img_gt = cv2.imread(r'E:\Aneurysm\resshift\train\S10110_origin_0.jpg') / 255.

    # -------------- cv2 -------------- #
    encode_param = [int(cv2.IMWRITE_JPEG_QUALITY), 20]
    _, encimg = cv2.imencode('.jpg', img_gt * 255., encode_param)
    img_lq = np.float32(cv2.imdecode(encimg, 1))
    cv2.imwrite(r'E:\code\ResShift-unet\temp_img\cv2_JPEG_20.png', img_lq)
    ...
    cv2.imwrite(r'E:\code\ResShift-unet\temp_img\pt_JPEG_20.png', np.array(tensor2img(out[0])))
    cv2.imwrite(r'E:\code\ResShift-unet\temp_img\pt_JPEG_40.png', np.array(tensor2img(out[1])))
