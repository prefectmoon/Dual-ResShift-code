...
class Vgg19_out(nn.Module):
    def __init__(self, requires_grad=False):
        ...
        vgg.load_state_dict(torch.load('./weights/vgg19-dcbb9e9d.pth'))
        vgg.eval()
...
if __name__ == "__main__":
    ...
    # img1 = np.array(cv2.imread("G:\code\ResShift-unet\saved_logs\2024-04-02-21-33\images\train\lq_00001.png")) / 255.0
    # img2 = np.array(cv2.imread("G:\code\ResShift-unet\saved_logs\2024-04-02-21-33\images\train\lq_00001.png")) / 255.0
    ...
    perceptual_loss134 = Perceptual_loss()
