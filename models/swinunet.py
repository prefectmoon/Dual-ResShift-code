...
class UNetModelSwin(nn.Module):
    ...
    def __init__(
        ...
        self.CBAM_com = CBAM(int(conv_ch / 2))
        self.CBAM_dist_1 = CBAM(int(conv_ch / 2))
        self.CBAM_dist_2 = CBAM(int(conv_ch / 2))
        self.CBAM_dist_3 = CBAM(int(conv_ch / 2))
    ...
    def forward(self, x, timesteps, lq=None, other=None):
        """
        Apply the model to an input batch.
        :param x: an [N x C x ...] Tensor of inputs.
        :param timesteps: a 1-D batch of timesteps.
